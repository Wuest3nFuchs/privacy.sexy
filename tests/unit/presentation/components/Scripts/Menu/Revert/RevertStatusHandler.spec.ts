  ...
  describe('getCurrentRevertStatus', () => {
    const testScenarios: ReadonlyArray<{
    ...
    }> = [
      {
        ...
        selectedScripts: [],
        expectedRevertStatus: RevertStatusType.NothingIsReversible,
      },
      {
      ...
      },
      {
        ...
        expectedRevertStatus: RevertStatusType.AllReverted,
      },
      {
      ...
      },
      {
        ...
        expectedRevertStatus: RevertStatusType.SomeReverted,
      },
      {
