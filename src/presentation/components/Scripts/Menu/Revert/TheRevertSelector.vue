<template>
  <MenuOptionList
    v-if="!RevertStatusType.NothingIsReversible"
    label="Revert"
  >
    <!--
    ...
    <TooltipWrapper>
      <MenuOptionListItem
        label="None"
        :enabled="canSetStatus(RevertStatusType.NoneReverted)"
    ...
    <TooltipWrapper>
      <MenuOptionListItem
        label="Selected"
        :enabled="canSetStatus(RevertStatusType.AllReverted)"
...
export default defineComponent({
  ...
  setup() {
    ...
    function canSetStatus(status: RevertStatusType): boolean {
      if (currentRevertStatusType.value === RevertStatusType.NothingIsReversible) {
        return false;
      }
      if (currentRevertStatusType.value === RevertStatusType.SomeReverted) {
        return true;
      }
